...
ALLOWED_HOSTS = os.environ.get('DJANGO_ALLOWED_HOSTS', '127.0.0.1,localhost,svrecai.up.railway.app,.up.railway.app,govardhan-c2q0.onrender.com,.fly.dev,.onrender.com').split(',')
CSRF_TRUSTED_ORIGINS = ['https://*.up.railway.app', 'https://*.onrender.com', 'https://*.fly.dev', 'https://*.loca.lt', 'https://*.serveo.net', 'https://*.localhost.run', 'http://127.0.0.1:8000', 'http://localhost:8000']
