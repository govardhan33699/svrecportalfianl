...
urlpatterns = [
    ...
    path("student/bulk-update-semester/", hod_views.bulk_update_students_semester, name='bulk_update_students_semester'),
    path("student/ajax-bulk-update-semester/", hod_views.ajax_bulk_update_semester, name='ajax_bulk_update_semester'),
